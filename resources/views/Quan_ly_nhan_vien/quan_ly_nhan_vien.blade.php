    ...
    <div class="container">
        ...
        <div class="table-section">
            ...
            <nav aria-label="Page navigation">
                ...
                @else
                    <li class="page-item">
                    <a class="page-link" href="{{ $nhan_viens->previousPageUrl() }}" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                    </li>
                @endif
                @foreach ($nhan_viens->getUrlRange(1, $nhan_viens->lastPage()) as $page => $url)
                    @if ($page == $nhan_viens->currentPage())
                    ...
                    @endif
                @endforeach
                @if ($nhan_viens->hasMorePages())
                    <li class="page-item">
                    <a class="page-link" href="{{ $nhan_viens->nextPageUrl() }}" aria-label="Next">
